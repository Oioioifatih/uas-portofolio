...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient p-10">
        {/* Dashboard Container */}
        <div className="flex w-full bg-white rounded-xl shadow-lg p-10">
          {/* Left Side: Profile Information */}
          <div className="flex-1">
            <div className="font-extrabold text-[48px] mt-10">
              <div>I'M Rizqi Al-Fatih</div>
              <div>
                <span className="text-[#808080  ]">Manajemen</span> Informatika
              </div>
            </div>
            <p className="text-[#767676] mt-3">Saya adalah mahasiswa semester 5 tingkat 3 manajemen informatika</p>
            <p className="text-[#767676] mt-3">Jadilah seperti bunga yang tumbuh di atas batu, tetaplah bersinar meski di tengah kesulitan.</p>
            <button className="btn-primary mt-5 px-4 py-2 rounded-lg bg-[#FFB11] text-white font-semibold">
              <span className="relative text-sm">Here Me</span>
            </button>
          </div>
          {/* Right Side: Avatar */}
          <div className="flex justify-center items-center">
            <img src="images/bear.png" alt="panda"/>
          </div>
        </div>
